...
def main() :
    ...
    # # # st.image(img)
        ...
        #             rotated_img.save('img.jpg')
            ...
            height = st.number_input('heigt 입력', 1, 100)
            ...
            #     img = load_image(img)
            #     number1 = st.number_input('가로의 길이를 지정해주세요',1,img.size[0])
            #     number2 = st.number_input('세로의 길이를 지정해주세요',1,img.size[1])
...
print('코드를 수정하면 소스제어창에 파란색 숫자가 생깁니다 ^^')